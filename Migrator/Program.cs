...
namespace Migrator
{
    ...
    class Program
    {
        ...
        static string mongoConnectionString = "mongodb+srv://m220student:m220password@sandbox.mongodb.net/test?retryWrites=true&w=majority";
        ...
        static async Task Main(string[] args)
        {
            ...
            if (datePipelineResults.Count > 0)
            {
                ...
                //var asd = new ReplaceOneModel<Movie>() ;

                bulkWriteDatesResult = await _moviesCollection.BulkWriteAsync(datePipelineResults.Select(d => new InsertOneModel<Movie>(d)));
            ...
            if (ratingPipelineResults.Count > 0)
            {
                ...
                bulkWriteRatingsResult = await _moviesCollection.BulkWriteAsync(ratingPipelineResults.Select(d => new InsertOneModel<Movie>(d)));
